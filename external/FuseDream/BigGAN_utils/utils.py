...
def prepare_parser():
  ...
  parser.add_argument('--desired_words', type=str, default='')
  parser.add_argument('--basis_expl_lambda', type=float, default=0)
  parser.add_argument('--opt_expl_lambda', type=float, default=0)
  parser.add_argument('--spatial_expl_lambda', type=float, default=0.)
  parser.add_argument('--start_idx', type=int, default=0)
  parser.add_argument('--end_idx', type=int, default=-1)
  parser.add_argument('--biggan_model', type=str, default=256)
  parser.add_argument('--noun_reduce_expl_coeff', type=float, default=-1.)
  parser.add_argument('--non_noun_reduce_expl_coeff', type=float, default=-1.)
  parser.add_argument('--expl_threshold', type=float, default=-1.)
  parser.add_argument('--caption_idx', type=int, default=0)
  parser.add_argument('--upload_results', action='store_true', default=False)
